...
checkpoint = torch.load('/scratch/anxiao2/checkpoints/train_similarity_saved_data_mar7_0_1500.pt')
...
for X, y in test_dataloader:
    ...
    out = tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=True, max_length=64)[0]
    gt = y
