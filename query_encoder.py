...
for i in range(25):
    ...
    for j, infos in enumerate(train_dataloader):
        ...
        context = [retreival_function(q, n_docs=1, question_encoder=modelq) for q in qs]
        ...
        if batch_num %1000 == 1:
            ...
            }, '/scratch/anxiao2/checkpoints2/train_dpr_encoder_dot' + str(i) + '_' + str(batch_num-1) + '.pt')
        batch_num += 1
